...
public class ASTLogicalExpression extends SimpleNode {
  ...
  public ASTLogicalExpression(MKParser p, int id) {
    super(p, id);
  }
  ...
  public Object jjtAccept(MKParserVisitor visitor, Object data) {
    ...
    public void generateNestedCode(LinkedList buffer, int start)
    {
        ...
        if (start > 1) {
            ...
            ASTRelationalExpression pe1 =
                (ASTRelationalExpression)children[0];
            pe1.generateCode(buffer);
        }
        ASTLogicalOperator mo =
            (ASTLogicalOperator)children[start];
        ASTRelationalExpression pe2 =
            (ASTRelationalExpression)children[start+1];
        MKInstruction arg2 =
            new MKInstruction(MKInstruction.MKIN_ARG, null);
