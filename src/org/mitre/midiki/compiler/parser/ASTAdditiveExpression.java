...
public class ASTAdditiveExpression extends SimpleNode {
  ...
  public ASTAdditiveExpression(MKParser p, int id) {
    super(p, id);
  }
  ...
  public Object jjtAccept(MKParserVisitor visitor, Object data) {
    ...
    public void generateNestedCode(LinkedList buffer, int start)
    {
        ...
        if (start > 1) {
            ...
            ASTMultiplicativeExpression pe1 =
                (ASTMultiplicativeExpression)children[0];
            pe1.generateCode(buffer);
        }
        ASTAdditiveOperator mo =
            (ASTAdditiveOperator)children[start];
        ASTMultiplicativeExpression pe2 =
            (ASTMultiplicativeExpression)children[start+1];
        MKInstruction arg2 =
            new MKInstruction(MKInstruction.MKIN_ARG, null);
