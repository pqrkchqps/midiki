/**
 * Implements the Element interface for Midiki datatypes.
 */
/*
 ...
 */
public class MidikiElement extends MidikiNode implements org.w3c.dom.Element {
    public MidikiElement(Object shadow) {
        super(shadow);
    ...
    public Object extractShadow() {
        ...
        _shadow = new Predicate(getTagName(), al);
        return _shadow;
    }
    ...
    public void setAttribute(String name, String value)
        throws DOMException
    {
        throw new DOMException(DOMException.NO_MODIFICATION_ALLOWED_ERR, "Cannot set attribute");
    }
    ...
    public void removeAttribute(String name)
        throws DOMException
    {
        throw new DOMException(DOMException.NO_MODIFICATION_ALLOWED_ERR, "Cannot remove attribute");
    }
    ...
    public NodeList getElementsByTagName(String name) {
        ...
        MidikiNodeList output = new MidikiNodeList();
        int cnt = nl.getLength();
        for (int i=0; i<cnt; i++) {
            MidikiElement me = (MidikiElement)nl.item(i);
            if (me.getTagName().equals(name)) {
                output.append(me);
            }
        }
        return output;
     ...
     * @since DOM Level 3
     */
/* NOTE: JDK 1.5 or equivalent libraries required for this method
