/**
 * Implements the Document interface for Midiki datatypes.
 */
 ...
 */
public class MidikiDocument extends MidikiNode implements org.w3c.dom.Document {
    public MidikiDocument() {
        super(null);
        _nodeType = DOCUMENT_NODE;
    }
    
    public MidikiDocument(Object node) {
        super(node);
        _nodeType = DOCUMENT_NODE;
    }
    ...
    public Object extractShadow() {
        MidikiElement elem = (MidikiElement)getDocumentElement();
        _shadow = elem.extractShadow();
        return _shadow;
    }
    ...
    public DocumentType getDoctype() {
        System.out.println("MidikiDocument.getDocType()");
        return null;
    }
    ...
    public DOMImplementation getImplementation() {
        System.out.println("MidikiDocument.getImplementation()");
        return null;
    }
    ...
    public Element getDocumentElement() {
        System.out.println("MidikiDocument.getDocumentElement()");
        if (_nodeList == null) return null;
        if (_nodeList.getLength() == 0) return null;
        return (MidikiElement)_nodeList.item(0);
    }
    ...
    public Element createElement(String tagName)
        ...
        Predicate p = new Predicate(tagName, al);
        MidikiElement me = new MidikiElement(p);
        return me;
    }
    ...
    public DocumentFragment createDocumentFragment() {
        //System.out.println("MidikiDocument.createDocumentFragment()");
        return new MidikiDocumentFragment(new LinkedList());
    }
    ...
    public Text createTextNode(String data) {
        //System.out.println("MidikiDocument.createTextNode("+data+")");
        return new MidikiTextNode(data);
    }
    ...
    public Comment createComment(String data) {
        //System.out.println("MidikiDocument.createComment("+data+")");
    ...
    public CDATASection createCDATASection(String data)
                                           throws DOMException {
        //System.out.println("MidikiDocument.createCDATASection("+data+")");
        throw new RuntimeException("Unsupported Operation");
    }
    ...
    public ProcessingInstruction createProcessingInstruction(String target, 
                                                             String data)
                                                             throws DOMException {
        //System.out.println("MidikiDocument.createProcessingInstruction()");
        throw new RuntimeException("Unsupported Operation");
    }
    ...
    public Attr createAttribute(String name)
                                throws DOMException {
        //System.out.println("MidikiDocument.createAttribute("+name+")");
        throw new RuntimeException("Unsupported Operation");
    }
    ...
    public EntityReference createEntityReference(String name)
                                                 throws DOMException {
        //System.out.println("MidikiDocument.createEntityReference("+name+")");
        throw new RuntimeException("Unsupported Operation");
    }
    ...
    public NodeList getElementsByTagName(String tagname) {
        System.out.println("MidikiDocument.getElementsByName("+tagname+")");
        return null;
    }
    ...
    public Node importNode(Node importedNode, 
                           boolean deep)
                           throws DOMException {
        System.out.println("MidikiDocument.importNode()");
        return null;
    }
    ...
    public Element createElementNS(String namespaceURI, 
        ...
        if (namespaceURI != null && namespaceURI.length() > 0) {
            // using this kludge for now; don't expect to use namespaces anytime soon.
    ...
    public Attr createAttributeNS(String namespaceURI, 
                                  String qualifiedName)
                                  throws DOMException {
        //System.out.println("MidikiDocument.createAttributeNS()");
        return null;
    }
    ...
    public NodeList getElementsByTagNameNS(String namespaceURI, 
                                           String localName) {
        System.out.println("MidikiDocument.getElementsByTagNameNS()");
        return null;
    }
    ...
    public Element getElementById(String elementId) {
        System.out.println("MidikiDocument.getElementById("+elementId+")");
        return null;
    }
    ...
    public String getInputEncoding() {
        System.out.println("MidikiDocument.getInputEncoding()");
        return null;
    }
    ...
    public String getXmlEncoding() {
        System.out.println("MidikiDocument.getXmlEncoding()");
        return null;
    }
    ...
    public boolean getXmlStandalone() {
        System.out.println("MidikiDocument.getXmlStandalone()");
    ...
    public void setXmlStandalone(boolean xmlStandalone)
                                  throws DOMException {
        System.out.println("MidikiDocument.setXmlStandalone("+xmlStandalone+")");
    ...
    public String getXmlVersion() {
        System.out.println("MidikiDocument.getXmlVersion()");
        return _xmlVersion;
    }
    ...
    public void setXmlVersion(String xmlVersion)
                                  throws DOMException {
        System.out.println("MidikiDocument.setXmlVersion("+xmlVersion+")");
    ...
    public boolean getStrictErrorChecking() {
        System.out.println("MidikiDocument.getStrictErrorChecking()");
    ...
    public void setStrictErrorChecking(boolean strictErrorChecking) {
        System.out.println("MidikiDocument.setStrictErrorChecking("+strictErrorChecking+")");
    ...
    public String getDocumentURI() {
        System.out.println("MidikiDocument.getDocumentURI()");
        return _documentURI;
    }
    ...
    public void setDocumentURI(String documentURI) {
        System.out.println("MidikiDocument.setDocumentURI("+documentURI+")");
    ...
    public Node adoptNode(Node source)
                          throws DOMException {
        System.out.println("MidikiDocument.adoptNode()");
        return null;
    }
     ...
     * @since DOM Level 3
     */
/* NOTE: requires JDK 1.5 or higher or equivalent libraries
    public DOMConfiguration getDomConfig() {
        System.out.println("MidikiDocument.getDomConfig()");
        return null;
    }
*/
    ...
    public void normalizeDocument() {
        System.out.println("MidikiDocument.normalizeDocument()");
    }
    ...
    public Node renameNode(Node n, 
                           ...
                           String qualifiedName)
                           throws DOMException {
        throw new DOMException(DOMException.NOT_SUPPORTED_ERR, "Cannot rename nodes in a MidikiDocument");
    }
