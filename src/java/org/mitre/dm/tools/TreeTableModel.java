...
public interface TreeTableModel extends TreeModel
{
    ...
    /**
     * Returns the value to be displayed for final node in <code>path</code>, 
     * at column number <code>column</code>.
     */
    public Object getPathValueAt(TreePath path, int column);
    ...
    /**
     * Get the renderer to be used for the tree-based column in the table.
     */
