 ...
 */
abstract public class DomainCell
    extends DomainImplementation
{
    private static Logger logger =
        Logger.getLogger("org.mitre.dm.qud.domain.DomainCell");
    /*
     * Domain queries
     */
    ...
    {
        CellHandlers domainCell =
            new CellHandlers(ContractDatabase.find("domain"));
