...
public class ManagePlanWithoutStack extends RuleSet
{
    ...
    public ManagePlanWithoutStack(Logger theLogger)
    {
        super();
        ...
        args = new LinkedList();
        args.add(p);
        forget_p = new Predicate("forget",args);
    ...
    protected void buildRuleSet()
    {
         ...
         * Since this might not be the same plan that originally placed
         * the information in common ground, feed the answer into the
        ...
        removePlanForgetItemC.extend(new NextPlanStep(forget_p));
        ExistsRule removePlanForgetItem =
            new ExistsRule(removePlanForgetItemC){
                    public boolean execute(InfoState infoState, Bindings bindings) {
                        consequence.advancePlan(infoState, bindings);
                        consequence.removeCommonGround(p, infoState, bindings);
                        return true;
                    }
                };
        ...
        /*
         * Remove "query" once executed.
         */
        Condition removePlanQueryC = new Condition();
        removePlanQueryC.extend(new NextPlanStep(query_q));
        removePlanQueryC.extend(new IsCommonGround(shared_belief));
        removePlanQueryC.extend(new ConsultDatabase(q, shared_belief, r));
        ExistsRule removePlanQuery =
            new ExistsRule(removePlanQueryC){
                    public boolean execute(InfoState infoState, Bindings bindings) {
                        consequence.addBelief(r, infoState, bindings);
                        consequence.advancePlan(infoState, bindings);
                        return true;
                    }
                };
        ...
        /*
         * Remove "method" once executed.
         */
        Condition removePlanMethodC = new Condition();
        removePlanMethodC.extend(new NextPlanStep(method_q));
        removePlanMethodC.extend(new IsCommonGround(shared_belief));
        removePlanMethodC.extend(new ConsultDatabase(q, shared_belief, r));
        ExistsRule removePlanMethod =
            new ExistsRule(removePlanMethodC){
                    public boolean execute(InfoState infoState, Bindings bindings) {
                        consequence.addBelief(r, infoState, bindings);
                        consequence.advancePlan(infoState, bindings);
                        return true;
