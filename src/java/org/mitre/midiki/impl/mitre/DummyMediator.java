...
public class DummyMediator implements Mediator
{
    private static Logger logger =
        Logger.getLogger("org.mitre.midiki.impl.mitre.DummyMediator");
    /**
    ...
    public boolean register(String asName)
    {
        logger.logp(Level.FINER,
                    "org.mitre.midiki.impl.mitre.DummyMediator",
                    "register",asName);
        myAgentName = asName;
        return true;
    }
    ...
    {
        logger.entering("org.mitre.midiki.impl.mitre.DummyMediator",
                              ...
                              Object results)
    {
        ...
        if (svc==null) {
            logger.logp(Level.WARNING,
                        "org.mitre.midiki.impl.mitre.DummyMediator",
                        "useService",request.toString()+" failed");
        } else {
            if (parameters instanceof CellInstance) {
        ...
        logger.exiting("org.mitre.midiki.impl.mitre.DummyMediator",
                       "useService",
                       request.toString());
        logger.logp(Level.FINEST,"org.mitre.midiki.impl.mitre.DummyMediator",
                    "useService",
