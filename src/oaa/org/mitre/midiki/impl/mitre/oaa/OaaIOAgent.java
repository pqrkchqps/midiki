...
import org.mitre.midiki.impl.mitre.oaa.*;
...
public class OaaIOAgent implements Agent
{
    private static Logger logger =
        Logger.getLogger("org.mitre.midiki.impl.mitre.oaa.OaaIOAgent");
    ...
    {
        logger.logp(Level.FINE,"org.mitre.midiki.impl.mitre.oaa.OaaIOAgent","connect","connecting to infoState",infoState);
        ...
        logger.logp(Level.FINE,"org.mitre.midiki.impl.mitre.oaa.OaaIOAgent","connect",(connected?"attached output listener":"could not attach output listener"));
    ...
    public Set getRequiredContracts()
    {
        ...
        contractSet.add(OaaContractDatabase.find("io_podium_input"));
        contractSet.add(OaaContractDatabase.find("io_podium_output"));
        System.out.println("io_podium_input = "+OaaContractDatabase.find("io_podium_input"));
        System.out.println("io_podium_output = "+OaaContractDatabase.find("io_podium_output"));
        return contractSet;
    }
    ...
    public Set getProvidedCells()
    {
        ...
        CellHandlers ioPodiumOutputCell = new CellHandlers(OaaContractDatabase.find("io_podium_output"));
